...
public class Constants {
    ...
    public static final double kSnapSwerveHeadingKp = 0.019;
    public static final double kSnapSwerveHeadingKi = 0.02;
    public static final double kSnapSwerveHeadingKd = 0.0021;
